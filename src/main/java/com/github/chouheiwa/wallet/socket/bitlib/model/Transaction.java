...
public class Transaction implements Serializable {
    ...
    * Transactions with minSequenceNumber lesses than MAX_INT-1 are eligible for full RBF
    ...
    *
    * @return true if any of its inputs has a nSequence lesser_than MAX_INT-1
    */
