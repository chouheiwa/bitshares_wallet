...
import static com.github.chouheiwa.wallet.socket.chain.config.GRAPHENE_MAX_SHARE_SUPPLY;
import static com.github.chouheiwa.wallet.socket.chain.types.UIA_ASSET_ISSUER_PERMISSION_MASK;
