...
import static com.github.chouheiwa.wallet.socket.chain.config.GRAPHENE_100_PERCENT;
...
public class fee_schedule {
    ...
    private int scale = config.GRAPHENE_100_PERCENT; ///< fee * scale / GRAPHENE_100_PERCENT
    ...
    public asset calculate_fee(operations.operation_type operationType, price core_exchange_rate) {
        ...
        BigInteger bigDefault = BigInteger.valueOf(config.GRAPHENE_100_PERCENT);
