...
import com.borderless.wallet.socket.bitlib.lambdaworks.crypto.PBKDF;
import com.borderless.wallet.socket.bitlib.util.BitUtils;
import com.borderless.wallet.socket.bitlib.util.ByteReader;
...
public class Bip39 {
   ...
   /**
    * Turn raw_type entropy into a BIP39 word list with checksum.
    * <p/>
    * The raw_type entropy must be 128, 160, 192, 244, or 256 bits
    *
    * @param rawEntropy the raw_type entropy
   ...
   public static String[] rawEntropyToWords(byte[] rawEntropy) {
      ...
      // Append the checksum to the raw_type entropy
