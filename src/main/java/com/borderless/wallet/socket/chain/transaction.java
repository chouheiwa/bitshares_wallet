...
import com.borderless.wallet.socket.chain.operations.base_operation;
import com.borderless.wallet.socket.chain.operations.operation_type;
import com.borderless.wallet.socket.common.UnsignedShort;
import com.borderless.wallet.socket.fc.bitutil;
import com.borderless.wallet.socket.fc.crypto.ripemd160_object;
...
public class transaction {
    ...
    public required_authorities get_required_authorities() {
        ...
        for (operation_type operationType : operations) {
            com.borderless.wallet.socket.chain.operations.base_operation baseOperation = (base_operation) operationType.operationContent;
